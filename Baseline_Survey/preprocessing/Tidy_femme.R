...
avg_questions = c("sons_household", "Average number of sons in the household in women who have given birth", "Fertility",
                  "daughters_household", "Average number of daughters in the household in women who have given birth", "Fertility",
                  "sons_not_household", "Average number of sons not in the household in women who have given birth", "Fertility",
                  "daughters_not_household", "Average number of daughters not in the household in women who have given birth", "Fertility",
                  "sons_died", "Average number of sons who died in women who have given birth", "Child Mortality",
                  "daughters_died", "Average number of sons who died in women who have given birth", "Child Mortality",
                  "ster_child_num", "Average number of children who women would want" , "Contraception")
...
cat_questions_xc = c("birth_assist_med", 1, "Doctor", "Assistance during birth" ,"Fertility",
                  ...
                  #
                  "ster_f_ster", 2, "Female sterilization", "Famility planning method knowledge", "Contraception",
                  "ster_m_ster", 2, "Male sterilization", "Famility planning method knowledge", "Contraception",
                  "ster_iud", 2, "IUD", "Famility planning method knowledge", "Contraception",
                  "ster_inje", 2, "Injectables", "Famility planning method knowledge", "Contraception",
                  "ster_impl", 2, "Implants", "Famility planning method knowledge", "Contraception",
                  "ster_pill", 2, "Pills", "Famility planning method knowledge", "Contraception",
                  "ster_m_cond", 2, "Condoms", "Famility planning method knowledge", "Contraception",
                  "ster_f_cond", 2, "Female condoms", "Famility planning method knowledge", "Contraception",
                  "ster_morn", 2, "Morning after pill", "Famility planning method knowledge", "Contraception",
                  "ster_fixe", 2, "Fixed day method / collar", "Famility planning method knowledge", "Contraception",
                  "ster_amen", 2, "Amenorrhea and breastfeeding method", "Famility planning method knowledge", "Contraception",
                  "ster_rhyt", 2, "Rhythm", "Famility planning method knowledge", "Contraception",
                  "ster_with", 2, "Withdrawal", "Famility planning method knowledge", "Contraception",
                  "ster_other", 2, "Other", "Famility planning method knowledge", "Contraception",
                  #
                  "ster_place_hosp_pu", 3, "Public hospital", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_cent_pu", 3, "Public health center", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_clincpf_pu", 3, "Public clinic", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_clinmo_pu", 3, "Public mobile clinic", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_agent_pu", 3, "Public health agent", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_hosp_pr", 3, "Private hospital", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_clinc_pr", 3, "Private clinic", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_pharm_pr", 3, "Pharmacie", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_med_pr", 3, "Private doctor", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_clinmo_pr", 3, "Private mobile clinic", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_agent_pr", 3, "Private health agent", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_bout", 3, "Boutique", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_reli", 3, "Religious institution", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_close", 3, "Relative / Friend", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_other_pu", 3, "Other public place", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_other_pr", 3, "Other private place", "Place to get family planning method knowledge", "Contraception",
                  "ster_place_other", 3, "Other", "Place to get family planning method knowledge", "Contraception",
                  #
                  "ster_used_f_ster", 4, "Female sterilization", "Famility planning method used", "Contraception",
                  "ster_used_m_ster", 4, "Male sterilization", "Famility planning method used", "Contraception",  
                  "ster_used_iud", 4, "IUD", "Famility planning method used", "Contraception",
                  "ster_used_inje", 4, "Injectables", "Famility planning method used", "Contraception",
                  "ster_used_impl", 4, "Implants", "Famility planning method used", "Contraception",
                  "ster_used_pill", 4, "Pills", "Famility planning method used", "Contraception",
                  "ster_used_m_cond", 4, "Condoms", "Famility planning method used", "Contraception",
                  "ster_used_f_cond", 4, "Female condoms", "Famility planning method used", "Contraception",
                  "ster_used_morn", 4, "Morning after pill", "Famility planning method used", "Contraception",
                  "ster_used_fixe", 4, "Fixed day method / collar", "Famility planning method used", "Contraception",
                  "ster_used_amen", 4, "Amenorrhea and breastfeeding method", "Famility planning method used", "Contraception",         
                  "ster_used_rhyt", 4, "Rhythm", "Famility planning method used", "Contraception",
                  "ster_used_with", 4, "Withdrawal", "Famility planning method used", "Contraception",
                  "ster_used_other", 4, "Other", "Famility planning method used", "Contraception",
                  #
                  "ster_using_f_ster", 5, "Female sterilization", "Current famility planning method", "Contraception",
                  "ster_using_m_ster", 5, "Male sterilization", "Current famility planning method", "Contraception",  
                  "ster_using_iud", 5, "IUD", "Current famility planning method", "Contraception",
                  "ster_using_inje", 5, "Injectables", "Current famility planning method", "Contraception",
                  "ster_using_impl", 5, "Implants", "Current famility planning method", "Contraception",
                  "ster_using_pill", 5, "Pills", "Current famility planning method", "Contraception",
                  "ster_using_m_cond", 5, "Condoms", "Current famility planning method", "Contraception",
                  "ster_using_f_cond", 5, "Female condoms", "Current famility planning method", "Contraception",
                  "ster_using_morn", 5, "Morning after pill", "Current famility planning method", "Contraception",
                  "ster_using_fixe", 5, "Fixed day method / collar", "Current famility planning method", "Contraception",
                  "ster_using_amen", 5, "Amenorrhea and breastfeeding", "Current famility planning method used", "Contraception",         
                  "ster_using_rhyt", 5, "Rhythm", "Current famility planning method", "Contraception",
                  "ster_using_with", 5, "Withdrawal", "Current famility planning method", "Contraception",
                  "ster_using_other", 5, "Other", "Current famility planning method", "Contraception",
                  #
